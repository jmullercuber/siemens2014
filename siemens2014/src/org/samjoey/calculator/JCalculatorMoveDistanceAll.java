 ...
 * @author Sam
 */
public class JCalculatorMoveDistanceAll extends JCalculator {

    private Board last;
    int player;

    public JCalculatorMoveDistanceAll(String white_or_black_or_all) {
        super(white_or_black_or_all + "MoveDistance");
        int player = (white_or_black_or_all.equals("White")?
                        1:
