...
var CenterOfMass = function(x_or_y, pieceWeight, filterFunc, calcName) {
    ...
    pieceWeight = pieceWeight || (function(pieceID) {
        return 1;
    });

    // What types of pieces do we want? Filter the list
    filterFunc = filterFunc || (function(pieceEntry) {
        return true;
    });
...
var PieceCount = function(pieceWeight, filterFunc, calcName) {
    ...
    filterFunc = filterFunc || (function(pieceEntry, board) {
        return true;
    });
...
var AveragePieceValue = function(white_or_black_or_all) {
    ...
    switch (white_or_black_or_all) {
        case "White":
            filterFunction = function(pieceEntry) {
                return pieceEntry.get(0).indexOf("W") == 0;
            };
            break;
        case "Black":
            filterFunction = function(pieceEntry) {
                return pieceEntry.get(0).indexOf("B") == 0;
            };
            break;
        default:
...
var PieceCountVars = function(white_or_black_or_all, weighted_or_unweighted) {
    ...
    switch (white_or_black_or_all) {
        case "White":
            filterFunction = function(pieceEntry, board) {
                return pieceEntry.get(0).indexOf("W") == 0;
            };
            break;
        case "Black":
